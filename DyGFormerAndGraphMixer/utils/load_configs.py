...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument(
        "--dataset_name", type=str, help="dataset to be used", default="wikipedia"
    )
    ...
    parser.add_argument(
        "--val_index", type=int, help="index of firts edge in the validation set"
    )
    parser.add_argument(
        "--test_index", type=int, help="index of firts edge in the test set"
    )
