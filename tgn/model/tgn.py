...
class TGN(torch.nn.Module):
  ...
  def compute_temporal_embeddings_no_negative(self, source_nodes, destination_nodes, edge_times,
                                  edge_idxs, n_neighbors=20):
    """
    Compute temporal embeddings for sources, destinations, and negatively sampled destinations.
  ...
  def compute_edge_probabilities_no_negative(self, source_nodes, destination_nodes, edge_times,
                                edge_idxs, n_neighbors=20):
    """
    Compute probabilities for edges between sources and destination and between sources and
    negatives by first computing temporal embeddings using the TGN encoder and then feeding them
    ...
    :return: Probabilities for both the positive and negative edges
    """
    source_node_embedding, destination_node_embedding = self.compute_temporal_embeddings_no_negative(
